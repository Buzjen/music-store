            ...
            <div className="items">
              {
                items.map(obj => (
                  <div className="basket-item">
                      <img width={100} height={100} className="basket-img" src={obj.imageUrl} alt="Covers"/>
                    <div className="basket-info">
                      <p className="basket-p">{obj.title}</p>
                        <b className="basket-b">{obj.price} USD</b>
                    </div>
                      <img onClick={() => onClearBasket(obj.id)} 
                      className="remove-img" 
                      width={30} 
                      height={30} src="/img/remove.svg" alt="Remove"/>
                </div>
